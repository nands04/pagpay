        ...
        e.data(a, "flexslider", i), h = {
            ...
            controlNav: {
                ...
                setupPaging: function() {
                    var t, a, n = "thumbnails" === i.vars.controlNav ? "control-thumbs" : "control-paging",
                        s = 1;
                    if (i.controlNavScaffold = e('<ol class="' + r + "control-nav " + r + n + '" aria-label="Slide controls"></ol>'), i.pagingCount > 1)
                        for (var o = 0; o < i.pagingCount; o++) {
                            ...
                            i.controlNavScaffold.append('<li aria-label="Show slide ' + s + " of " + i.pagingCount + '">' + t + "</li>"), s++
                        }
                    i.controlsContainer ? e(i.controlsContainer).append(i.controlNavScaffold) : i.append(i.controlNavScaffold), h.controlNav.set(), h.controlNav.active(), i.controlNavScaffold.delegate("a, img", d, (function(t) {
                ...
                setupManual: function() {
                    i.controlNav = i.manualControls, h.controlNav.active(), i.controlNav.bind(d, (function(t) {
                        if (t.preventDefault(), "" === c || c === t.type) {
                            var a = e(this),
                                n = i.controlNav.index(a);
                ...
                update: function(t, a) {
                    i.pagingCount > 1 && "add" === t ? i.controlNavScaffold.append(e('<li><a href="#"></a></li>')) : 1 === i.pagingCount ? i.controlNavScaffold.find("li").remove() : i.controlNav.eq(a).closest("li").remove(), i.controlNavScaffold.find("li").each((function(t, a) {
                        e(a).find("a").text(t + 1)
                    })), h.controlNav.set(), i.pagingCount > 1 && i.pagingCount !== i.controlNav.length ? i.update(a, t) : h.controlNav.active()
                }
            },
            directionNav: {
                setup: function() {
                    ...
                    i.customDirectionNav ? i.directionNav = i.customDirectionNav : i.controlsContainer ? (e(i.controlsContainer).append(t), i.directionNav = e("." + r + "direction-nav li a", i.controlsContainer)) : (i.append(t), i.directionNav = e("." + r + "direction-nav li a", i)), h.directionNav.update(), i.directionNav.bind(d, (function(t) {
                        var a;
                        t.preventDefault(), "" !== c && c !== t.type || (a = e(this).hasClass(r + "next") ? i.getTarget("next") : i.getTarget("prev"), i.flexAnimate(a, i.vars.pauseOnAction)), "" === c && (c = t.type), h.setToClearWatchedEvent()
                    }))
                },
                update: function() {
                    var e = r + "disabled";
            ...
            pausePlay: {
                setup: function() {
                    ...
                    i.controlsContainer ? (i.controlsContainer.append(t), i.pausePlay = e("." + r + "pauseplay a", i.controlsContainer)) : (i.append(t), i.pausePlay = e("." + r + "pauseplay a", i)), h.pausePlay.update(i.vars.slideshow ? r + "pause" : r + "play"), i.pausePlay.bind(d, (function(t) {
                        t.preventDefault(), "" !== c && c !== t.type || (e(this).hasClass(r + "pause") ? (i.manualPause = !0, i.manualPlay = !1, i.pause()) : (i.manualPause = !1, i.manualPlay = !0, i.play())), "" === c && (c = t.type), h.setToClearWatchedEvent()
                    }))
                },
                update: function(e) {
            ...
            touch: function() {
                ...
                if (o) {
                    a.style.msTouchAction = "none", a._gesture = new MSGesture, a._gesture.target = a, a.addEventListener("MSPointerDown", (function(e) {
                        ...
                        passive: !0
                    }), a._slider = i, a.addEventListener("MSGestureChange", (function(e) {
                        e.stopPropagation();
                        var t = e.target._slider;
                        if (!t) return;
                        var i = -e.translationX,
                            o = -e.translationY;
                        if (x += u ? o : i, r = (t.vars.rtl ? -1 : 1) * x, h = u ? Math.abs(x) < Math.abs(-i) : Math.abs(x) < Math.abs(-o), e.detail === e.MSGESTURE_FLAG_INERTIA) return void setImmediate((function() {
                            a._gesture.stop()
                        }));
                        (!h || Number(new Date) - l > 500) && (e.preventDefault(), !m && t.transitions && (t.vars.animationLoop || (r = x / (0 === t.currentSlide && x < 0 || t.currentSlide === t.last && x > 0 ? Math.abs(x) / s + 2 : 1)), t.setProps(n + r, "setTouch")))
                    }), {
                        passive: !0
                        ...
                        r && h ? i.vars.slideshow && i.play() : r ? !i.vars.pauseOnAction && i.play() || (i.vars.slideshow = !1) : i.vars.slideshow && !i.vars.pauseOnAction && i.play() || (i.vars.slideshow = !1);
                        e = null, t = null, r = null, n = null, x = 0
                    }), {
                        passive: !0
                    })
                } else d = function(r) {
                    i.animating ? r.preventDefault() : (window.navigator.msPointerEnabled || 1 === r.touches.length) && (i.pause(), s = u ? i.h : i.w, l = Number(new Date), g = r.touches[0].pageX, S = r.touches[0].pageY, n = p && v && i.animatingTo === i.last ? 0 : p && v ? i.limit - (i.itemW + i.vars.itemMargin) * i.move * i.animatingTo : p && i.currentSlide === i.last ? i.limit : p ? (i.itemW + i.vars.itemMargin) * i.move * i.currentSlide : v ? (i.last - i.currentSlide + i.cloneOffset) * s : (i.currentSlide + i.cloneOffset) * s, e = u ? S : g, t = u ? g : S, a.addEventListener("touchmove", c, {
                        passive: !0
                    }), a.addEventListener("touchend", f, {
                        passive: !0
                    }))
                }, c = function(a) {
                    g = a.touches[0].pageX, S = a.touches[0].pageY, r = u ? e - S : (i.vars.rtl ? -1 : 1) * (e - g);
                    (!(h = u ? Math.abs(r) < Math.abs(g - t) : Math.abs(r) < Math.abs(S - t)) || Number(new Date) - l > 500) && (a.preventDefault(), !m && i.transitions && (i.vars.animationLoop || (r /= 0 === i.currentSlide && r < 0 || i.currentSlide === i.last && r > 0 ? Math.abs(r) / s + 2 : 1), i.setProps(n + r, "setTouch")))
                }, f = function(o) {
                    if (a.removeEventListener("touchmove", c, !1), i.animatingTo === i.currentSlide && !h && null !== r) {
                        var d = v ? -r : r,
                    ...
                    a.removeEventListener("touchend", f, !1), r && h ? i.vars.slideshow && i.play() : r ? !i.vars.pauseOnAction && i.play() || (i.vars.slideshow = !1) : i.vars.slideshow && !i.vars.pauseOnAction && i.play() || (i.vars.slideshow = !1), e = null, t = null, r = null, n = null
            ...
            if (i.vars.animationLoop || t === i.currentSlide || (i.direction = t > i.currentSlide ? "next" : "prev"), f && 1 === i.pagingCount && (i.direction = i.currentItem < t ? "next" : "prev"), !i.animating && (i.canAdvance(t, o) || n) && i.is(":visible")) {
                if (f && s) {
                    ...
                    if (i.atEnd = 0 === t || t === i.count - 1, d.flexAnimate(t, !0, !1, !0, o), i.direction = i.currentItem < t ? "next" : "prev", d.direction = i.direction, Math.ceil((t + 1) / i.visible) - 1 === i.currentSlide || 0 === t) return i.currentItem = t, i.slides.removeClass(r + "active-slide").eq(t).addClass(r + "active-slide"), i.slides.attr("aria-hidden", "true").eq(t).removeAttr("aria-hidden"), !1;
                    i.currentItem = t, i.slides.removeClass(r + "active-slide").eq(t).addClass(r + "active-slide"), i.slides.attr("aria-hidden", "true").eq(t).removeAttr("aria-hidden"), t = Math.floor(t / i.visible)
                }
                if (i.animating = !0, i.animatingTo = t, a && i.pause(), i.vars.before(i), i.syncExists && !o && h.sync("animate"), i.vars.controlNav && h.controlNav.active(), p || (i.slides.removeClass(r + "active-slide").eq(t).addClass(r + "active-slide"), i.slides.attr("aria-hidden", "true").eq(t).removeAttr("aria-hidden")), i.atEnd = 0 === t || t === i.last, i.vars.directionNav && h.directionNav.update(), t === i.last && (i.vars.end(i), i.vars.animationLoop || i.pause()), m) l ? (i.slides.eq(i.currentSlide).css({
                    opacity: 0,
                    zIndex: 1
                }), i.slides.eq(t).css({
                    opacity: 1,
                    ...
                    var c, g, S, x = u ? i.slides.filter(":first").height() : i.computedW;
                    p ? (c = i.vars.itemMargin, g = (S = (i.itemW + c) * i.move * i.animatingTo) > i.limit && 1 !== i.visible ? i.limit : S) : g = 0 === i.currentSlide && t === i.count - 1 && i.vars.animationLoop && "next" !== i.direction ? v ? (i.count + i.cloneOffset) * x : 0 : i.currentSlide === i.last && 0 === t && i.vars.animationLoop && "prev" !== i.direction ? v ? 0 : (i.count + 1) * x : v ? (i.count - 1 - t + i.cloneOffset) * x : (t + i.cloneOffset) * x, i.setProps(g, "", i.vars.animationSpeed), i.transitions ? (i.vars.animationLoop && i.atEnd || (i.animating = !1, i.currentSlide = i.animatingTo), i.container.unbind("webkitTransitionEnd transitionend"), i.container.bind("webkitTransitionEnd transitionend", (function() {
            ...
            i.transitions && (s = i.isFirefox ? u ? "translate3d(0," + s + ",0)" : "translate3d(" + parseFloat(s) + "px,0,0)" : u ? "translate3d(0," + s + ",0)" : "translate3d(" + (i.vars.rtl ? -1 : 1) * parseFloat(s) + "px,0,0)", a = void 0 !== a ? a / 1e3 + "s" : "0s", i.container.css("-" + i.pfx + "-transition-duration", a), i.container.css("transition-duration", a)), i.args[i.prop] = s, (i.transitions || void 0 === a) && i.container.css(i.args), i.container.css("transform", s)
        }, i.setup = function(t) {
            var a, n;
            m ? (i.vars.rtl ? i.slides.css({
                ...
                float: "left",
                display: "block"
            }), i.cloneCount = 2, i.cloneOffset = 1, "init" !== t && i.container.find(".clone").remove(), i.container.append(h.uniqueID(i.slides.first().clone().addClass("clone")).attr("aria-hidden", "true")).prepend(h.uniqueID(i.slides.last().clone().addClass("clone")).attr("aria-hidden", "true"))), i.newSlides = e(i.vars.selector, i), a = v ? i.count - 1 - i.currentSlide + i.cloneOffset : i.currentSlide + i.cloneOffset, u && !p ? (i.container.height(200 * (i.count + i.cloneCount) + "%").css("position", "absolute").width("100%"), setTimeout((function() {
                i.newSlides.css({
                    display: "block"
            ...
            p || (i.slides.removeClass(r + "active-slide").eq(i.currentSlide).addClass(r + "active-slide"), i.slides.attr("aria-hidden", "true").eq(i.currentSlide).removeAttr("aria-hidden")), i.vars.init(i), i.doMath()
        }, i.doMath = function() {
